...
nav_order: 87
permalink: /14-topic-library/87-STAR-Method/
---

<div class="topic-meta">
  <span class="topic-badge">Topic #87</span>
...
```mermaid
graph TD
    A[Behavioral Question] --> B[Identify Competency]
    B --> C[Select Relevant Story]
    C --> D[S: Set Context 30 sec]
    D --> E[T: Define Task 20 sec]
    E --> F[A: Describe Actions 90 sec]
    F --> G[R: Share Results 30 sec]
    G --> H[Add Learning/Takeaway]
```
...
```mermaid
graph TD
    A[One Strong Story] --> B{Question Theme}
    B -->|Leadership| C[Emphasize influence]
    B -->|Teamwork| D[Emphasize collaboration]
    B -->|Pressure| E[Emphasize prioritization]
    B -->|Conflict| F[Emphasize resolution]
    B -->|Initiative| G[Emphasize proactivity]
```
