...
parent: "Online Assessments & Aptitude"
nav_order: 16
permalink: /14-topic-library/16-Psychometric-Test/
---

<div class="topic-meta">
  <span class="topic-badge">Topic #16</span>
  <span class="topic-cat">&#129504; &nbsp; Online Assessments & Aptitude</span>
</div>

{% raw %}
# Psychometric Test — Complete Interview Preparation Guide
...
```mermaid
flowchart TD
    A[Job Application] --> B{Resume Screening}
    B -->|Pass| C[Online Psychometric Test]
    B -->|Fail| D[Rejected]
    C --> E[Cognitive Ability Test]
    C --> F[Personality Questionnaire]
    C --> G[Situational Judgment Test]
    E --> H{Score Analysis}
    F --> H
    G --> H
    H -->|Meets Threshold| I[Interview Stage]
    H -->|Below Threshold| D
    I --> J[Final Assessment]
    J --> K{Hire/No Hire}
    K -->|Hire| L[Offer Extended]
    K -->|No Hire| M[Rejection Letter]
```
...
graph TD
    subgraph OCEAN["Big Five Personality Model"]
        O[Openness<br/>Curious vs Cautious]
        C[Conscientiousness<br/>Organized vs Flexible]
        E[Extraversion<br/>Sociable vs Reserved]
        A[Agreeableness<br/>Cooperative vs Competitive]
        N[Neuroticism<br/>Anxious vs Calm]
    end

    O -->|High| Creative_Roles[Creative Roles]
    C -->|High| Detail_Roles[Detail-Oriented Roles]
    E -->|High| People_Roles[People-Facing Roles]
    A -->|High| Team_Roles[Team-Oriented Roles]
    N -->|Low| Stress_Roles[High-Pressure Roles]

    Creative_Roles --> Fit_Score[Person-Job Fit Score]
    Detail_Roles --> Fit_Score
    People_Roles --> Fit_Score
    Team_Roles --> Fit_Score
    Stress_Roles --> Fit_Score
```
...
```mermaid
flowchart TD
    Start[What to Assess?] --> Q1{Cognitive Ability?}
    Q1 -->|Yes| CA[Cognitive Battery<br/>Numerical/Verbal/Abstract]
    Q1 -->|No| Q2{Personality Traits?}
    Q2 -->|Yes| P[Personality Questionnaire<br/>Big Five/OCEAN]
    Q2 -->|No| Q3{Job-Related Decisions?}
    Q3 -->|Yes| SJT[Situational Judgment Test<br/>Work Scenarios]
    Q3 -->|No| Q4{Emotional Skills?}
    Q4 -->|Yes| EI[Emotional Intelligence Test<br/>Self-Awareness/Social]
    Q4 -->|No| Q5{Honesty/Integrity?}
    Q5 -->|Yes| IT[Integrity Test<br/>Honesty/Ethics]
    Q5 -->|No| II[Interest Inventory<br/>Career Preferences]
```
