---
layout: default
title: "Joining Preparation"
permalink: /105-Joining-Preparation/
nav_exclude: true
search_exclude: true
---
...
```mermaid
gantt
    title Pre-Joining Preparation Timeline
    dateFormat  YYYY-MM-DD
    section Notice Period
    Resignation & Handover      :a1, 2024-01-01, 14d
    Knowledge Transfer          :a2, after a1, 10d
    Final Goodbyes              :a3, after a2, 4d
    section Administrative
    Background Check Prep       :b1, 2024-01-01, 7d
    Document Gathering          :b2, 2024-01-08, 7d
    Tax Paperwork               :b3, 2024-01-15, 5d
    section Preparation
    Team Connection             :c1, 2024-01-15, 10d
    Tech Stack Research         :c2, 2024-01-20, 14d
    Environment Setup           :c3, 2024-02-01, 7d
```

### First 90 Days Framework
```mermaid
flowchart LR
    A[Days 1-30<br/>LEARN] --> B[Days 31-60<br/>CONTRIBUTE]
    B --> C[Days 61-90<br/>LEAD]
    
    A --> A1[Understand Culture]
    A --> A2[Meet Stakeholders]
    A --> A3[Learn Tech Stack]
    
    B --> B1[Take Small Tasks]
    B --> B2[Code Reviews]
    B --> B3[Build Relationships]
    
    C --> C1[Own Features]
    C --> C2[Propose Improvements]
    C --> C3[Set Goals]
```
