...
permalink: /100-Bar-Raiser-Round/
nav_exclude: true
search_exclude: true
---
...
```mermaid
flowchart TD
    A[Resume Screening] --> B[Phone Screen]
    B --> C[Technical Rounds]
    C --> D[Behavioral Round]
    D --> E[Bar Raiser Round]
    E --> F{Bar Raiser Decision}
    F -->|Hire| G[Offer Extended]
    F -->|No Hire| H[Rejection]
    F -->|Borderline| I[Debate with Hiring Team]
    I -->|Overruled| G
    I -->|Upheld| H
```
...
```mermaid
flowchart LR
    A[Situation<br/>Set Context<br/>20%] --> B[Task<br/>Your Role<br/>Included in S]
    B --> C[Action<br/>What YOU Did<br/>60%]
    C --> D[Result<br/>Quantified Impact<br/>20%]
```

### LP Assessment Framework
```mermaid
pie title LP Focus Areas in Bar Raiser Round
    "Customer Obsession" : 15
    "Ownership" : 15
    "Deliver Results" : 12
    "Dive Deep" : 10
    "Earn Trust" : 10
